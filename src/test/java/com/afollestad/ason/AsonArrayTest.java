...
public class AsonArrayTest {
    ...
    @Test public void get_array_test() {
        AsonArray<Integer> arrayItem = new AsonArray<Integer>()
                .add(1, 2, 3, 4);
        AsonArray<AsonArray> array = new AsonArray<AsonArray>()
                .add(arrayItem);
    ...
    @Test public void get_object_array_null_test() {
    ...
    @Test public void put_null_test() {
        AsonArray<Integer> array = new AsonArray<Integer>()
                .addNull()
                .add((Integer[]) null);
    ...
    @Test public void test_array_in_array() {
        AsonArray<Integer> one = new AsonArray<Integer>()
                .add(1, 2, 3, 4);
        AsonArray<Integer> two = new AsonArray<Integer>()
                .add(5, 6, 7, 8);
        AsonArray<AsonArray> parent = new AsonArray<AsonArray>()
                .add(one, two);
